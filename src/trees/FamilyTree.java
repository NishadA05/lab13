...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
     ...
     // Returns a list of ancestors of this TreeNode, starting with this node’s parent and
     // ending with the root. Order is from recent to ancient.
     ArrayList<TreeNode> collectAncestorsToList(TreeNode root)
     {
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
	    ...
	    ArrayList<TreeNode> ancestorsOf1 = node1.collectAncestorsToList(root);
	    ArrayList<TreeNode> ancestorsOf2 = node2.collectAncestorsToList(root);
